      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="index-2.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
           ...
           <li class=" nav-item"><a href="index-2.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Products</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
            <ul class="menu-content">
              <li ><a class="menu-item" href="product-add.php">Add New Products</a>
              </li>
              <li><a class="menu-item" href="product-verify-notverified.php">Not Verified</a>
              </li>
              <li><a class="menu-item" href="product-verify-pending.php">Pending</a>
              </li>
              <li><a class="menu-item" href="product-verify-verified.php">Verified</a>
              </li>
            </ul>
          </li>
