...
if(isset($_POST['add_model']))
{
  ...
  $model_id = $_POST['add_models'];

  foreach ($model_id as $model_id)
  {
      $insert = mysqli_query($conn,"insert into assign_models values(null,'$product_id','$model_id','0')");
  //echo "insert into assign_brands values(null,'$product_id','$model_id','0')";
  }
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <div class="checkbox">
                            <?php
                            $brand = mysqli_query($conn,"select * from brands b, brand_models m, assign_brands ab where m.brand_id = b.brand_id and ab.brand_id = b.brand_id and ab.product_id ='$product_id' ");
                            foreach ($brand as $brand)
                            {
                            ?>
                          <label><input type="checkbox" name="add_models[]" value="<?php echo $brand['brand_model_id'];?>"><?php echo $brand['model_name'];?></label>
                          <?php 
                      }
                      ?>
                        </div>
                        <input type="hidden" name="product_id" value="<?php echo $product_id;?>">
                        <button class="btn btn-primary" type="submit" name="add_model" value="submit">Add Now</button>
                    </form>
