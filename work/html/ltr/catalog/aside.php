    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="brands.php"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Brand</span></a>
          </li>

          <li class=" nav-item"><a href="brand-model-add.php"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Brand Models</span></a>
          </li>

          <li class=" nav-item"><a href="model-sub-assembly.php"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Models SubAssembly</span></a>
          </li>

          <li class=" nav-item"><a href="model-sub-assembly-details.php"><i class="ft-mail"></i><span class="menu-title" data-i18n="">SubAssembly Details</span></a>
          </li>

          <li class=" nav-item"><a href="verified-product-list.php?id=brands"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Assign Brands</span></a>
          </li>

          <li class=" nav-item"><a href="verified-product-list.php?id=models"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Assign Models</span></a>
          </li>

          <li class=" nav-item"><a href="verified-product-list.php?id=subassembly"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Assign Subassembly</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="verified-product-list.php?id=subassembly-details"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Assign Details</span></a>
           ...
           <li class=" nav-item"><a href="#"><i class="ft-monitor"></i><span class="menu-title" data-i18n="">operations</span></a>
            <ul class="menu-content">
               ...
               <li><a class="menu-item" href="product-pending.php">Pending Products</a></li>
               <li><a class="menu-item" href="product-verified.php">Verified Products </a></li>
