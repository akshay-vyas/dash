...
if(isset($_POST['addsubassembly']))
{
    ...
    $subassembly_name = $_POST['subassembly_name'];

    $insert = mysqli_query($conn,"insert into model_subassembly values(null,'$brand_id','$model_id','$subassembly_name','0')");

    header('Location:model-sub-assembly.php');
}
                            ...
                            ?>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Sub Assembly Name</label>
                                            <input type="text" id="projectinput1" class="form-control" placeholder="Name" name="subassembly_name">
                                        </div>
                                    </div>
                    </div>
